...
public class DashboardView extends StackPane implements StaffModelSubscriber
{
...
//            dashboardVBox.getChildren().add(datePicker);
//            dashboardVBox.setSpacing(10);
//            dashboardVBox.setPadding(new Insets(10));
//
//            this.getChildren().add(dashboardVBox);
//        }
    ...
    public DashboardView(){
        ...
        Label addLabel = new Label("Add Tips");
        ...
        Label idLabel = new Label("Hours Worked: ");
        ...
        Label sinLabel = new Label("Tips earned: ");
        ...
        addVBox.getChildren().addAll(mainMenu,addLabel, datePicker, fNameHBox,lNameHBox,idHBox,sinHBox,postionHBox,submit,updateButton,deleteButton, clearButton);
        ...
        iDCol = new TableColumn<>("Hours worked");
        ...
        sinCol = new TableColumn<>("Tips earned");

        staffTable.getColumns().addAll(lNameCol,fNameCol,positionCol,iDCol,sinCol);
    ...
    public void setController(ProgramController controller){
        mainMenu.setOnAction(controller::openStaffInfoView);
